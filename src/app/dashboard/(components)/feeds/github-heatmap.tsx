...
//the syntax is importing the whole module then selecting the githubcal from the modle as there is no default component then we disable ssr for that specifically
